...
public class ImagenDAOTest {
	...
	public void setUp() throws Exception {
		...
		directorioDatos = directorioEntrada + File.separator 
				+ "src" + File.separator 
				+ "test" + File.separator 
				+ "java" + File.separator 
				+ "org" + File.separator 
	...
	public void testLeerImagenI() throws IOException {
		...
		assertTrue(imagen.getNumeroBandas() == 5, mensaje);
	}
	...
	public void testEscribirImagenI() throws IOException {
		...
		try {
		  ...
		  //  Según sea Linux o MacOS, o bien Windows
		  //  Windows introduce un carácter de retorno de carro antes del que indica 
		  //  cambio de línea (CR + LF), como hacen Linux y Mac OS (LF)
		  assertTrue(fcabecera.length()==71 || fcabecera.length()==78);
	...
	public void testEscribirImagenD() throws IOException {
		...
		try {
		  ...
		  //  Windows introduce un carácter de retorno de carro antes del que indica 
		  //  cambio de línea (CR + LF), como hacen Linux y Mac OS (LF)
		  assertTrue(fcabecera.length()==70 || fcabecera.length()==77 );
